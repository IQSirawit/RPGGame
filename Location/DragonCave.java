...
public class DragonCave extends Location {
    ...
    public void enter(Party party) {
        ...
        List<Character> enemyParty = generateFinalBoss(party);
    ...
    private List<Character> generateFinalBoss(Party party) {
        ...
        int bossHP = 500 + (bossLevel * 80);
        int bossDamage = 40 + (bossLevel * 8);
        int bossDefense = 20 + (bossLevel * 4);
        int bossSpeed = 30 + (bossLevel);
        int bossArmor = 15 + bossLevel; // เกราะหนาแบบมังกร

        Weapon dragonBreath = new Weapon("Inferno Breath", "Magic", bossDamage / 2, "Burn");
        ...
        fireDragon.setAuto(true); // ให้บอสโจมตีอัตโนมัติ
